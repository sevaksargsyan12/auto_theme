...
<section class="section-cover" style="background-image: url(<?php _e($header_section['background']);?>)">
    ...
    <div class="container max-container">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-7 col-xl-6 text-md-start text-center">
                <div class="cover-div">
        ...
        <div class="row justify-content-center">
            ...
            <div class="row service-apart-row mobile-bigger">
				<?php foreach ($items as $item): ?>
                    <div class="col-xl-4 col-lg-6 col-sm-12 col-12 testimonial-container">
                ...
                <div class="row info-items-row mobile-bigger">
					...
					if (!empty($items) && !is_wp_error($items)) {
						...
						foreach ($items as $item) {
							$i++;
							?>
                            <div class="col-lg-<?php _e($item_index);?> col-md-<?php _e($item_index * 2);?> info-item">
                                <div class="info-item-icon-wrapper">
                                    <div class="info-item-icon <?php _e($i === count($items)?'':'bg')?>">
...
<section class="section-cover design-versatility" style="background-image: url(<?php _e($design_versatility['background']);?>)">
    <div class="container max-container h-100">
        <img class="section-cover-mobile-bg w-100"  src="<?php _e($design_versatility["background_mobile"])?>">
        <div class="row h-100">
        ...
        <div class="row justify-content-center">
            ...
            <div class="row service-apart-row mobile-bigger">
				<?php foreach ($items as $item):
					$item_index = floor(12/count($items));
					?>
                    <div class="col-lg-<?php _e($item_index);?> col-sm-12">
                        <div class="service-apart-div">
                            <h5><?php _e($item['title']);?></h5>
                            <p><?php _e($item['description']);?></p>
                            <img src="<?php _e($item['icon']);?>"
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
									<?php
									echo do_shortcode('[contact-form-7 id="4e900d6" title="Glass Railings"]')
									?>
                                </div>
