<?php
/* Template Name: Doors and partitions */
get_header();
$page_id = get_the_ID();
...
?>
<section class="service-apart-section first">
	<div class="container max-container">
...
$items = $why_choose_section['items'];?>
<section class="service-apart-section last">
	<div class="container max-container">
		<div class="row justify-content-center">
			<div class="col-12 col-lg-7 text-center">
				<h2><?php _e($why_choose_section['title']);?></h2>
			...
			<div class="row service-apart-row mobile-bigger">
				<?php foreach ($items as $item):
					$item_index = floor(12/count($items));
					?>
					<div class="col-lg-<?php _e($item_index);?> col-12">
						<div class="service-apart-div">
							<h5><?php _e($item['title']);?></h5>
							<p><?php _e($item['description']);?></p>
							<img src="<?php _e($item['icon']);?>"
...
<?php $design_versatility = get_field('elevate_productivity', $page_id);?>
<section class="section-cover last design-versatility" style="background-image: url(<?php _e($design_versatility['background']);?>)">
    <div class="section-cover-mobile-bg"  style="background-image: url(<?php _e($design_versatility['background_mobile']);?>)"></div>
    <div class="container max-container h-100">
        <div class="row h-100">
            <div class="col-12 col-lg-8 col-xl-6 text-md-start text-center h-100 d-flex align-items-center p-sm-0">
                <div class="cover-div p-0">
                    <h1><?php _e($design_versatility['title']) ?></h1>
                    <h6><?php _e($design_versatility['description']) ?></h6>
                    <a class="custom-button" href="#estimate">Get FREE Estimate Now!<img
...
<section class="customers-section first">
						...
						<div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
									<?php
									echo do_shortcode('[contact-form-7 id="3d285cb" title="Office doors and partitions"]')
									?>
                                </div>
