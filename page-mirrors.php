...
<section class="section-cover" style="background-image: url(<?php _e($header_section['background']);?>)">
    ...
    <div class="container max-container">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-6 col-xl-6 text-md-start text-center">
				<div class="cover-div">
...
?>
<section class="section-shape-space">
    <div class="container max-container">
        <div class="row">
            <div class="col-12 text-md-start text-center">
                <div class="text-block">
                    <h1 class="text-center"><?php _e($shape_space['title']) ?></h1>
                    <p class="text-center"><?php _e($shape_space['description']) ?></p>
                </div>
            </div>
            <div class="col-12">
                <div class="shape-space-items d-flex row">
					<?php foreach ($items as $item):?>
                        <div class="col-lg-6 col-12 shape-space-item-wrapper">
    ...
    <div class="container max-container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 text-center">
                <h2 class="px-lg-5"><?php _e($why_choose_section['title']);?></h2>
...
<?php $design_versatility = get_field('creating_a_perfect_custom_mirror', $page_id);?>
<section class="section-cover creating-perfect-mirror section-quarter mb-0 " style="background-image: url(<?php _e($design_versatility['background']);?>)">
    <div class="container max-container h-100">
        <div class="row h-100">
            <img class="section-cover-mobile-bg"  src="<?php _e($design_versatility['background']);?>">
            <div class="col-12 col-md-12 col-lg-6 col-xl-6 text-md-start text-center h-100 d-flex align-items-center p-0 position-relative">
                <div class="cover-div p-0 position-absolute">
...
<?php $design_versatility = get_field('transforming_spaces_with_custom_mirrors', $page_id);?>
<section class="section-cover transforming-spaces section-quarter" style="background-image: url(<?php _e($design_versatility['background']);?>)">
    <div class="container max-container h-100">
        <div class="row h-100 justify-content-end">
            ...
            <div class="col-12 col-md-12 col-lg-6 col-xl-6 text-md-start text-center h-100 d-flex align-items-center p-0 position-relative">
                <div class="cover-div p-0 position-absolute">
                    <h1><?php _e($design_versatility['title']) ?></h1>
                    <h6><?php _e($design_versatility['description']) ?></h6>
                    <a class="custom-button" href="tel:747 5000 747">Call Now<img
                                src="<?php echo get_template_directory_uri(); ?>/images/right.svg"
                                alt="button icon"/>
                    </a>
                </div>
...
<section class="customers-section">
    ...
    <div class="container max-container">
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <div class="customers-slider-testimonials-mirrors m-auto">
					<?php foreach ($items as $item):?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
									<?php
									echo do_shortcode('[contact-form-7 id="2b4be13" title="Mirrors"]')
									?>
                                </div>
