<?php
/* Template Name: Hardware and Finishes */
get_header();
$page_id = get_the_ID();
...
<section class="section-cover second design-versatility" style="background-image: url(<?php _e($design_versatility['background']);?>)">
...
?>
<section class="customers-section first slider-section">
    <div class="container max-container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-7 text-center">
...
<?php $images_slider = get_field('images_slider_second', $page_id);
$items = $images_slider['items'];
?>
<section class="customers-section secondary-slider slider-section">
    <div class="container max-container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-7 text-center">
                <h2><?php _e($images_slider['title']);?></h2>
...
<section class="upgrade-spaces-section hingles-to-handles">
    <div class="container max-container">
...
<?php $design_versatility = get_field('your_trusted_partner_in_glass_hardware_solutions', $page_id);?>
<section class="section-cover design-versatility you-trusted" style="background-image: url(<?php _e($design_versatility['background']);?>)">
    <div class="section-cover-mobile-bg"  style="background-image: url(<?php _e($design_versatility['background_mobile']);?>)"></div>
    <div class="container max-container h-100">
        <div class="row h-100">
            <div class="col-12 col-md-12 col-lg-8 col-xl-6 text-md-start text-center h-100 d-flex align-items-center p-sm-0">
...
<?php $images_slider = get_field('images_slider_last', $page_id);
$items = $images_slider['items'];
?>
<section class="customers-section last-slider slider-section">
    <div class="container max-container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-7 text-center">
                <h2><?php _e($images_slider['title']);?></h2>
...
<?php $section_upgrade_your_space = get_field('upgrade_your_space', $page_id); ?>
<section class="customers-section hardware-and-finishes">
    ...
    <div class="container max-container">
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <div class="customers-slider-hardware-and-finishes-testimonials m-auto" style="max-width: 690px;">
					<?php foreach ($items as $item):?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
									<?php
									echo do_shortcode('[contact-form-7 id="2779907" title="Hardware and finishes"]')
									?>
                                </div>
